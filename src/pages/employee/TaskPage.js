...
// //                       className="p-2 bg-green-600 text-white rounded-md hover:bg-green-700 flex items-center justify-center text-sm sm:text-base w-10 h-10 sm:w-10 sm:h-10"
// //                       disabled={isLoading}
...
// //                             <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 text-sm font-medium" title={task.assignedBy}>
...
// //     // Mark task as viewed to remove highlight
...
// //     // Mark task as viewed to remove highlighting
// //     setViewedTasks(prev => new Set([...prev, task._id]));
// //     // Also open the task view modal
// //     handleViewTask(task);
// //   };
...
// //     const currentUserEmail = "ayush.sain@sevenprocure.com"; // This should ideally come from auth context
// //     const now = new Date();
// //     const fiveMinutesAgo = new Date(now.getTime() - 5 * 60 * 1000); // 5 minutes ago
    
// //     // Check if there are any recent comments from other users
// //     return task.comments.some(comment => {
// //       if (comment.user === currentUserEmail) return false; // Skip own comments
// //       const commentTime = new Date(comment.timestamp);
// //       return commentTime > fiveMinutesAgo; // Only highlight if comment is within last 5 minutes
// //     });
// //   };
...
// //               </div>
// //             )}
// //             <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 lg:h-full ">
// //               <div className="mb-6">
// //                 <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-4">
// //                   <h2 className="text-xl sm:text-2xl font-bold text-blue-600">
// //                     My Tasks
...
// //                 >
// //                   <div className="bg-white rounded-lg shadow-xl w-full max-w-[95vw] sm:max-w-2xl md:max-w-3xl lg:max-w-4xl p-3 sm:p-4 md:p-6 max-h-[95vh] sm:max-h-[90vh] overflow-y-auto mx-2 sm:mx-0">
// //                     <div className="flex items-center justify-between mb-6">
// //                       <h2 className="text-lg sm:text-xl font-semibold text-gray-900">
// //                         {editId ? "Edit Task" : "Create New Task"}
// //                       </h2>
...
//                         <span className="hidden sm:inline"><FunnelX/></span>
//                       </button>
//                     )}
//                   </div>
//                 </div>
