...
//                     : "",
//                   dueTime: updatedTask.task.dueTime || "N/A",
...
//     console.log(
//       `Marking comments as seen for task ${task._id} by user ${currentUserEmail}`
//     );
//     console.log("current user email is :", currentUserEmail);

//     if (!currentUserEmail) {
//       console.error(
//         "Current user email is not set. Cannot mark comments as seen."
//       );
//       return;
//     }
...
//             const errorData = await response.json();
//             console.error(
//               `Failed to mark comment ${comment._id} as seen:`,
//               errorData.message
//             );
//             setToast({
...
//           setError(
//             `Cannot change overdue task to "${status}". Allowed: ${allowedStatuses.join(
//               ", "
//             )}. Kindly contact your manager to update due date first.`
//           );
...
const TaskPage = () => {
  ...
  // Moved fetchTasks out of useEffect and wrapped in useCallback
  ...
  }, [token, pageSize, currentPage, employees, setTasks, setTotalTasks, setError, setIsLoadingTasks]);
