...
//             )}
//             {toast && (
//               <div className="fixed top-4 right-4 z-50 px-4 py-2 rounded-md shadow-lg max-w-md w-full text-sm bg-blue-500 text-white">
//                 {toast.message}
//               </div>
//             )}
//             <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
...
//                         </button>
//                       </form>
//                       <div className="min-h-64 max-h-64 overflow-y-auto bg-gray-50 p-3 rounded-lg shadow-sm">
//                         {viewTask.comments.length > 0 ? (
//                           [...viewTask.comments]
//                             .sort(
//                               (a, b) => new Date(b.timestamp) - new Date(a.timestamp)
...
//                                     </p>
//                                     {comment.profileImage && (
//                                       <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 text-sm font-medium mt-1">
//                                         {getInitials(comment.userName || comment.user)}
//                                       </div>
//                                     )}
//                                   </div>
//                                 </div>
...
//             )}
//             {toast && (
//               <div className="fixed top-4 right-4 z-50 px-4 py-2 rounded-md shadow-lg max-w-md w-56  text-sm bg-blue-500 text-white">
//                 {toast.message}
//               </div>
//             )}
