...
// // // Helper function to parse DD/MMMM/YYYY to ISO format for backend
...
// //   // Categorized fields for view/edit modal
// //   const detailFields = {
// //     personalInfo: [
...
// //               <button
// //                 className="flex items-center gap-2 px-4 py-2 bg-blue-800 hover:bg-blue-900 text-white rounded-lg font-semibold shadow text-sm sm:text-base"
...
// //                     {employees.length === 0 ? (
// //                       <tr>
// //                         <td colSpan={tableColumns.length} className="text-center text-blue-500 py-8">
...
// //             <div className="bg-white rounded-xl shadow-xl w-full max-w-md sm:max-w-lg md:max-w-6xl max-h-[90vh] overflow-y-auto p-4 sm:p-6">
...
// //                   </div>
// //                   {isEditing && (
// //                     <label className="absolute bottom-0 right-0 bg-blue-800 hover:bg-blue-900 text-white p-1 sm:p-2 rounded-full cursor-pointer transition-colors">
// //                       <FaCamera size={12} />
// //                       <input
// //                         type="file"
// //                         accept="image/*"
...
// //                   <button
// //                     className="px-4 py-2 bg-blue-200 text-blue-700 rounded-lg font-semibold text-sm sm:text-base hover:bg-blue-300"
// //                     onClick={() => {
// //                       if (modalType === 'add') {
// //                         setModalOpen(false);
// //                         setModalEmployee(initialEmployee);
...
// //                   </button>
// //                   <button
// //                     className="flex items-center gap-2 px-4 py-2 bg-blue-800 hover:bg-blue-900 text-white rounded-lg font-semibold text-sm sm:text-base"
...
// //                 <button
// //                   className="px-3 py-1 sm:px-4 sm:py-2 rounded-lg bg-blue-200 text-blue-700 font-semibold text-sm sm:text-base hover:bg-blue-300"
...
// //   // Handle file upload for documents in modal
...
// //       console.log('Sending employee data:', Object.fromEntries(employeeData)); // Log payload for debugging
...
// //                             {modalEmployee.aadharFront ? (
// //                               <div className="text-center">
// //                                 <p className="text-sm truncate max-w-[200px]">{modalEmployee.aadharFront.name || 'Aadhar Front'}</p>
// //                                 <button
// //                                   className="text-xs text-blue-600 hover:text-blue-800 mt-1"
// //                                   onClick={() => handleModalChange('aadharFront', null)}
// //                                 >
// //                                   Remove
// //                                 </button>
// //                               </div>
...
// //                             {modalEmployee.aadharFront ? (
// //                               <a
// //                                 href={modalEmployee.aadharFront instanceof File ? URL.createObjectURL(modalEmployee.aadharFront) : modalEmployee.aadharFront}
// //                                 target="_blank"
// //                                 rel="noopener noreferrer"
...
// //                         {isEditing ? (
// //                           <div className="relative w-full h-32 border-2 border-dashed border-blue-200 rounded-lg flex flex-col items-center justify-center text-gray-500 bg-gray-50 hover:bg-blue-50 transition-colors">
// //                             {modalEmployee.aadharBack ? (
// //                               <div className="text-center">
// //                                 <p className="text-sm truncate max-w-[200px]">{modalEmployee.aadharBack.name || 'Aadhar Back'}</p>
// //                                 <button
// //                                   className="text-xs text-blue-600 hover:text-blue-800 mt-1"
// //                                   onClick={() => handleModalChange('aadharBack', null)}
// //                                 >
// //                                   Remove
// //                                 </button>
// //                               </div>
...
// //                             {modalEmployee.aadharBack ? (
// //                               <a
// //                                 href={modalEmployee.aadharBack instanceof File ? URL.createObjectURL(modalEmployee.aadharBack) : modalEmployee.aadharBack}
// //                                 target="_blank"
// //                                 rel="noopener noreferrer"
// //                                 className="flex items-center space-x-2"
// //                               >
...
// //                         {isEditing ? (
// //                           <div className="relative w-full h-32 border-2 border-dashed border-blue-200 rounded-lg flex flex-col items-center justify-center text-gray-500 bg-gray-50 hover:bg-blue-50 transition-colors">
// //                             {modalEmployee.bankPassbook ? (
// //                               <div className="text-center">
// //                                 <p className="text-sm truncate max-w-[200px]">{modalEmployee.bankPassbook.name || 'Bank Passbook'}</p>
// //                                 <button
// //                                   className="text-xs text-blue-600 hover:text-blue-800 mt-1"
// //                                   onClick={() => handleModalChange('bankPassbook', null)}
// //                                 >
// //                                   Remove
// //                                 </button>
// //                               </div>
...
// //                             {modalEmployee.bankPassbook ? (
// //                               <a
// //                                 href={modalEmployee.bankPassbook instanceof File ? URL.createObjectURL(modalEmployee.bankPassbook) : modalEmployee.bankPassbook}
// //                                 target="_blank"
// //                                 rel="noopener noreferrer"
// //                                 className="flex items-center space-x-2"
// //                               >
...
// //                         {isEditing ? (
// //                           <div className="relative w-full h-32 border-2 border-dashed border-blue-200 rounded-lg flex flex-col items-center justify-center text-gray-500 bg-gray-50 hover:bg-blue-50 transition-colors">
// //                             {modalEmployee.panCard ? (
// //                               <div className="text-center">
// //                                 <p className="text-sm truncate max-w-[200px]">{modalEmployee.panCard.name || 'PAN Card'}</p>
// //                                 <button
// //                                   className="text-xs text-blue-600 hover:text-blue-800 mt-1"
// //                                   onClick={() => handleModalChange('panCard', null)}
// //                                 >
// //                                   Remove
// //                                 </button>
// //                               </div>
...
// //                             {modalEmployee.panCard ? (
// //                               <a
// //                                 href={modalEmployee.panCard instanceof File ? URL.createObjectURL(modalEmployee.panCard) : modalEmployee.panCard}
// //                                 target="_blank"
// //                                 rel="noopener noreferrer"
// //                                 className="flex items-center space-x-2"
// //                               >
...
//   const [loading, setLoading] = useState(true);
//   const [error, setError] = useState(null);
//   const [saving, setSaving] = useState(false); // New state for save/edit loader
...
//       setModalEmployee((prev) => ({
//         ...prev,
//         [field]: file, // Store the File object for FormData
//       }));
//     } else {
//       setError('Please upload a valid PDF file');
//     }
...
//     } catch (err) {
//       console.error(`${modalType === 'add' ? 'Add' : 'Edit'} Employee Error:`, err.response?.data || err.message);
//       setSaving(false); // Stop saving loader on error
//       if (err.response?.status === 401) {
//         setError('Session expired or unauthorized. Please log in again.');
//         localStorage.removeItem('token');
//         localStorage.removeItem('userEmail');
...
//     try {
//       setSaving(true); // Start saving loader for delete
//       await axios.delete(`${BASE_URL}/admin/deleteemployees/${employeeId}`, {
//         headers: {
//           Authorization: `Bearer ${token}`,
//         },
...
//         {modalOpen && (
//           <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 sm:p-6">
//             <div className="bg-white rounded-xl shadow-xl w-full max-w-md sm:max-w-lg md:max-w-6xl max-h-[90vh] overflow-y-auto p-4 sm:p-6 relative">
//               {saving && (
...
//         {deleteIndex !== null && (
//           <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
//             <div className="bg-white rounded-xl shadow-xl w-full max-w-xs sm:max-w-sm p-4 sm:p-6 relative">
//               {saving && (
//                 <div className="absolute inset-0 bg-white bg-opacity-75 flex items-center justify-center z-10">
//                   <div className="flex items-center gap-2 text-blue-500">
//                     <FaSpinner className="animate-spin" size={24} />
...
const EmployeeListPage = () => {
  ...
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState(null);
  const [saving, setSaving] = useState(false); // State for save/edit loader
