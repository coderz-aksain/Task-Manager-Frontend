        ...
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
          ...
          {modalOpen && (
            <div
              ...
              style={{ zIndex: 1000 }} // Ensure modal is above everything
              onClick={() => setModalOpen(false)}
            >
              <div
                className="bg-white rounded-xl shadow-xl w-full max-w-md sm:max-w-lg md:max-w-3xl lg:max-w-5xl xl:max-w-7xl max-h-[90vh] overflow-y-auto p-2 sm:p-4 relative"
                style={{ zIndex: 1010 }}
...
@media (max-width: 640px) {
  ...
  .sm\\:max-w-lg { max-width: 90vw !important; }
}
`}
</style>