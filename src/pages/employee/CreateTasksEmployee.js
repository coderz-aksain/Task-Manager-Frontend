...
//               const formattedAuctionDate = `${aDay.padStart(2, '0')}-${aMonth.padStart(2, '0')}-${aYear}`;
//               try {
//                 setLoading(true);
//                 let response;
...
//                           <div>
//                             <label className="block text-sm font-medium text-gray-700 mb-2">
//                               Pre Bid (INR) <span className="text-red-600">*</span>
//                             </label>
...
//                                 placeholder="Enter pre-bid amount in INR"
//                                 disabled={isSubmitting}
//                                 step="0.01"
//                               />
//                             </div>
