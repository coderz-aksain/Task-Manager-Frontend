...
// // import { Link, useNavigate, useLocation } from 'react-router-dom';
// // import { Calendar, CheckSquare, User, LogOut, X, Menu, ChevronLeft, ChevronRight } from 'lucide-react';
...
// //           ${isOpen || isSidebarExpanded ? 'translate-x-0 w-64' : '-translate-x-full'}
// //           lg:translate-x-0 lg:static
...
//   const menuItems = [
//     { name: 'Tasks', icon: CheckSquare, path: '/employee/tasks', tooltip: 'View your tasks' },
//     { name: 'Profile', icon: User, path: '/employee/profile', tooltip: 'Edit your profile' },
//   ];
...
//             position: relative;
//           }
//           .sidebar-nav li .group-hover\:opacity-100 {
//             opacity: 0;
//             transition: opacity 0.2s ease-in-out;
//           }
//           .sidebar-nav li:hover .group-hover\:opacity-100 {
//             opacity: 1;
//           }
//         `}
//       </style>
